...
export const PATHS: PathMeta[] = [
  ...
  {
    slug: "openclaw-setup",
    title: "OpenClaw Setup: All Platforms",
    summary: "Install and run OpenClaw on Windows, macOS, a VPS, or Raspberry Pi. Your autonomous AI agent, on your hardware.",
  ...
  },
  {
    ...
    title: "OpenClaw Mastery",
    summary: "Master autonomous AI agents in WhatsApp and Telegram: SKILL.md authoring, 10 production use cases, security guardrails, and the HEARTBEAT loop.",
    section: "OpenClaw Ecosystem",
    tier: "pro",
    status: "available",
    lessonCount: 10,
