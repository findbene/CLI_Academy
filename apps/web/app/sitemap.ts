...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const entries: MetadataRoute.Sitemap = [
    ...
    { url: `${baseUrl}/prompt-doctor`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.8 },
    { url: `${baseUrl}/asset-vault`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.8 },
    { url: `${baseUrl}/runtime-lab`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.8 },
    { url: `${baseUrl}/workflow-studio`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.8 },
