...
- Name: smoke.spec.ts >> 404 handling >> unknown route shows 404 page
- Location: e2e\smoke.spec.ts:186:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/this-page-does-not-exist
Call log:
  - navigating to "http://localhost:3000/this-page-does-not-exist", waiting until "load"
