...
- Name: smoke.spec.ts >> Public pages >> /resources loads without error
- Location: e2e\smoke.spec.ts:26:9

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/resources
Call log:
  - navigating to "http://localhost:3000/resources", waiting until "load"
