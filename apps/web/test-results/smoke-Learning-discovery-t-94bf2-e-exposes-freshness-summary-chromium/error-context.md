...
- Name: smoke.spec.ts >> Learning discovery >> trust page exposes freshness summary
- Location: e2e\smoke.spec.ts:87:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/trust
Call log:
  - navigating to "http://localhost:3000/trust", waiting until "load"
