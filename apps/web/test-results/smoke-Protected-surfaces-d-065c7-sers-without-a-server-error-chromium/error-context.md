...
- Name: smoke.spec.ts >> Protected surfaces >> /downloads handles unauthenticated users without a server error
- Location: e2e\smoke.spec.ts:110:9

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/downloads
Call log:
  - navigating to "http://localhost:3000/downloads", waiting until "load"
