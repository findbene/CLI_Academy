...
const localAssets: LearningAsset[] = [
  ...
  {
    category: "field-manual",
    compatibility: ["All chapters", "Offline study", "Guided labs"],
    exampleUse: "Keep this nearby when you want a one-page recap for each chapter without reopening the full lesson.",
    formats: [
      {
        fileName: "chapter-mini-notes-series.md",
        format: "md",
        mimeType: "text/markdown; charset=utf-8",
        storagePath: "chapter-mini-notes-series.md",
      },
    ],
    previewBullets: [
      "Mini Notes format for every chapter",
      "Command recap blocks",
      "Common mistakes and quick checks",
    ],
    printable: true,
    recommendedLessons: [],
    recommendedPaths: ["01-start-here", "03-claude-code", "08-claude-cowork", "11-openclaw-and-claw-runtime-foundations"],
    slug: "chapter-mini-notes-series",
    summary:
      "A printable standard for the one-page Mini Notes PDF that every chapter now carries across setup, prompt, runtime, and capstone lessons.",
    tier: "free",
    title: "Chapter Mini Notes series",
    updatedAt: "2026-04-10",
    versionLabel: "mini-notes-v1",
  },
  {
    category: "quick-reference",
    compatibility: ["Course 4", "Course 19", "2026 updates"],
    exampleUse: "Use this to keep the small freshness layer current without re-reading an entire course when platform details change.",
    formats: [
      {
        fileName: "2026-runtime-and-deployment-update-brief.md",
        format: "md",
        mimeType: "text/markdown; charset=utf-8",
        storagePath: "2026-runtime-and-deployment-update-brief.md",
      },
    ],
    previewBullets: [
      "Claude 4.6 notes",
      "Agent SDK improvements",
      "NemoClaw and MCP v2 changes",
    ],
    printable: true,
    recommendedLessons: [],
    recommendedPaths: ["11-openclaw-and-claw-runtime-foundations", "15-secure-remote-setups", "19-capstones-portfolio-proof-and-job-ready-evidence"],
    slug: "2026-runtime-and-deployment-update-brief",
    summary:
      "The short update brief used by the Course 4 and Course 19 micro-modules to keep runtime and deployment guidance current without bloating the fast path.",
    tier: "free",
    title: "2026 runtime and deployment update brief",
    updatedAt: "2026-04-10",
    versionLabel: "2026-update-v1",
  },
  {
    category: "workflow-pack",
    compatibility: ["Mastery layer", "Cost engineering", "Multi-provider agents"],
    exampleUse: "Use this after the Week 8 capstone when you need to price, monitor, and fail over a production-minded agent workflow.",
    formats: [
      {
        fileName: "cost-engineering-multi-provider-playbook.md",
        format: "md",
        mimeType: "text/markdown; charset=utf-8",
        storagePath: "cost-engineering-multi-provider-playbook.md",
      },
    ],
    previewBullets: [
      "Token budget worksheet",
      "Fallback provider planning",
      "SLO and alert starter checks",
    ],
    printable: true,
    recommendedLessons: [],
    recommendedPaths: ["19-capstones-portfolio-proof-and-job-ready-evidence"],
    slug: "cost-engineering-multi-provider-playbook",
    summary:
      "A mastery-layer playbook for token budgets, fallback providers, scaling decisions, and observability checks after the final capstone works locally.",
    tier: "pro",
    title: "Cost engineering and multi-provider playbook",
    updatedAt: "2026-04-10",
    versionLabel: "mastery-cost-v1",
  },
  {
    category: "starter-pack",
    compatibility: ["Community showcase", "Portfolio proof", "Week 8 capstone"],
    exampleUse: "Use this when packaging your final capstone into a polished submission bundle with README, diagrams, and demo script.",
    formats: [
      {
        fileName: "capstone-showcase-submission-kit.md",
        format: "md",
        mimeType: "text/markdown; charset=utf-8",
        storagePath: "capstone-showcase-submission-kit.md",
      },
    ],
    previewBullets: [
      "README checklist",
      "Architecture diagram prompts",
      "Showcase submission rubric",
    ],
    printable: true,
    recommendedLessons: [],
    recommendedPaths: ["19-capstones-portfolio-proof-and-job-ready-evidence"],
    slug: "capstone-showcase-submission-kit",
    summary:
      "A portfolio and showcase packaging kit for the final Autonomous AI Workforce submission, including evidence, README, and demo-script guidance.",
    tier: "free",
    title: "Capstone showcase submission kit",
    updatedAt: "2026-04-10",
    versionLabel: "showcase-kit-v1",
  },
];
